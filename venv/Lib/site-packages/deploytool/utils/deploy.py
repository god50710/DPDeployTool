...
from fabric.context_managers import settings, show
from fabric.contrib.files import exists
from fabric.operations import open_shell
from fabric.utils import abort

from . import commands, instance, source
...
class WebsiteDeployment(object):
    ...
    """
    def __init__(self, vhost_path, project_name, project_name_prefix, project_settings_directory, stamp, pause_at, skip_migrate, restart_services, python_version, task_args, task_kwargs):
    ...
    def deploy(self):
        with settings(abort_exception=AbortException):
            ...
            if not self.skip_migrate:
                # This will also call self.rollback() on failure
    ...
    def create_virtualenv(self):
        ...
        instance.create_virtualenv(self.virtualenv_path, self.python_version)
    ...
    def rollback(self, exception):
        ...
        with settings(abort_exception=None):
            abort(red('Deploy failed and was rolled back. Caused by:\n%s' % trace))
    ...
    def migrate(self):
        ...
        commands.django_manage(self.virtualenv_path, self.source_path, 'migrate --noinput')
