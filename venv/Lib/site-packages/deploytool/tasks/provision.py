# Deprecated: Remove this module at some point

import os
import warnings

from fabric.api import abort, env, hide, local, prompt, settings, sudo
...
class ProvisioningTask(Task):
    ...
    def __init__(self):
        warnings.warn('Provisioning tasks are deprecated, please remove them from your fabfile', DeprecationWarning, stacklevel=2)
        super(ProvisioningTask, self).__init__()
